...
| 패턴/기법     | [[NestJS_DTO]] (class-validator · @Type · PartialType) · [[NestJS_Swagger]] (@ApiProperty · type:[String] · 응답 타입) · [[NestJS_Throttle]] (스로틀링 · 서비스 레벨 force) · [[NestJS_Email]] (Resend · Nodemailer · 인증메일 · 재설정) · [[NestJS_Logger]] (내장 로거) · [[NestJS_Pagination]] · [[NestJS_Idempotency]] (중복 요청 방어 · 멱등키 · 낙관적/비관적 잠금) |
