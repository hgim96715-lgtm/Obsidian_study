...
| React 훅 기초     | —                                                     | —                                                               | [[React_useMemo_useCallback_useEffect]] · [[React_Context]] · [[React_useRef]] · [[React_useId]] · [[React_Portal]] · [[React_AsyncUI]] (비동기 UI 패턴 · loading/error · optimistic) | —                                                                                                                                                       |
...
| 언어         | 노트                                                                                                                                                                                                                                                                                                                                                                                                                          |
| ---------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| TypeScript | [[TS_TypeAssertion]] (`as`) · [[TS_Generics]] (`<T>`) · [[TS_Class_Patterns]] (`implements`/`extends`/`readonly`) · [[TS_Utility_Types]] (`Record`/`Partial`/`Omit`/`ReturnType`) · [[TS_PartialUpdate]] (PATCH 객체 만들기) · [[TS_Type_Guards]] (`typeof`/`instanceof`/`in`/`is`/`unknown`) · [[TS_Unknown_Any]] (`any`/`unknown`/`void`/`never` · `Promise<void>` vs `Promise<unknown>`)                                      |
